...
create index idx_hub_ranking_log_hub on hub_ranking_log (hub_id);
create index idx_hub_ranking_log_hub_project on hub_ranking_log (hub_id, project_linear_id);
